		...
		<tfoot class="footer">
			<tr>
				<td colspan="6">
					...
					<c:if test="${p.page != 1}">
						<a href="list.free?page=1" class="btn">◀◀</a>&nbsp;&nbsp;
					</c:if>
					...
					<c:if test="${p.page > p.pagePerBlock}">
						<a href="list.free?page=${p.beginPage - 1}" class="btn">◀</a>&nbsp;&nbsp;
					</c:if>
					...
					<c:forEach var="i" begin="${p.beginPage}" end="${p.endPage}">
						...
						<c:if test="${p.page != i}">
							<a href="list.free?page=${i}" class="page_num">${i}</a>&nbsp;&nbsp;
						</c:if>
					</c:forEach>
					...
					<c:if test="${p.endPage != p.totalPage}">
						<a href="list.free?page=${p.endPage + 1}" class="btn">▶</a>&nbsp;&nbsp;
					</c:if>
					...
					<c:if test="${p.page != p.totalPage}">
						<a href="list.free?page=${p.totalPage}" class="btn">▶▶</a>&nbsp;&nbsp;
					</c:if>
